...
class RequestUtil {
    ...
    private void getInstance(){
        ...
        OkHttpClient.Builder builder = new OkHttpClient().newBuilder().sslSocketFactory(factory);
        mOkHttpClient =  builder.hostnameVerifier(new TrustAllHostnameVerifier()).build();;
